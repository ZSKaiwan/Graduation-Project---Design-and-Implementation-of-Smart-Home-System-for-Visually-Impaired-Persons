...
void PWM_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Pin=GPIO_Pin_0|GPIO_Pin_1;//默认PA0是TIM2通道1的复用，PA1是TIM2通道2的复用所以开启这俩IO口...
...
void PWM_SetCompare1N(uint16_t Compare) //内侧侧舵机CCR 通道1 PA0
{
	
	TIM_SetCompare1(TIM2, Compare);     	
}

void PWM_SetCompare2W(uint16_t Compare)  //外侧舵机CCR 通道2  PA1
{
